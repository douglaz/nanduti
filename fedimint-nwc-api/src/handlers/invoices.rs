...
use fedimint_nwc_core::models::Amount;
...
pub async fn create_invoice(
    ...
    let federation = if let Some(fed_id) = req.federation_id {
        ...
        federations
            .into_iter()
            .find(|f| f.status == fedimint_nwc_core::federation::FederationStatus::Online)
            .ok_or_else(|| {
                (
    ...
    use fedimint_nwc_core::models::{Transaction, TransactionState, TransactionType};
